...
int main(int argc, char * argv[])
{
  ...
  auto node = rclcpp::Node::make_shared("random_controller_node");
  ...
  std::string pkgpath = ament_index_cpp::get_package_share_directory("bt_random_controller");
  std::string xml_file = pkgpath + "/behavior_tree_xml/random_controller.xml";
