...
#include "bt_random_controller/IsObstacle.hpp"
...
: BT::ConditionNode(xml_tag_name, conf)
{
  ...
  laser_sub_ = node_->create_subscription<sensor_msgs::msg::LaserScan>(
    "/base_scan", 100, std::bind(&IsObstacle::laser_callback, this, _1));
...
{
  factory.registerNodeType<bt_random_controller::IsObstacle>("IsObstacle");
}
